...
all:
	...
	mv main.pdf out/
doc:
	pandoc main.md --reference-doc=custom-reference.docx --lua-filter=pandoc/scholarly-metadata.lua --lua-filter=pandoc/author-info-blocks.lua  --filter pandoc-crossref --citeproc -o main.docx 
	mv main.docx out/
log:
